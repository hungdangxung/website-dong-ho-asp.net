...
namespace DongHoDemo2.Areas.Admin.Controllers
{
    ...
    public class AdminOrdersController : Controller
    {
        ...
        public AdminOrdersController(DongHoDemoContext context)
        {
            _context = context;
        }
        ...
        {
            var dongHoDemoContext = _context.Orders.Include(o => o.Customer).Include(o => o.Shipper).Include(o => o.TransactStatus);
