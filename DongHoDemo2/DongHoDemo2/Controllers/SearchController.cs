        ...
        public IActionResult FilterProduct(int idRange)
        {
            ...
            switch (idRange)
            {
                case 1:
                    ...
                    .Include(x => x.Cat)
                    .AsNoTracking()
                    .Where(x => x.Discount >= 0 && x.Discount <= 100000)
                    .OrderByDescending(x => x.ProductName)
                    .ToList();
                    break;
                case 2:
                    ...
                    .Include(x => x.Cat)
                    .AsNoTracking()
                    .Where(x => x.Discount >= 100000 && x.Discount <= 500000)
                    .OrderByDescending(x => x.ProductName)
                    .ToList();
                    break;
                case 3:
                    ...
                    .Include(x => x.Cat)
                    .AsNoTracking()
                    .Where(x => x.Discount >= 500000 && x.Discount <= 1000000)
                    .OrderByDescending(x => x.ProductName)
                    .ToList();
                    break;
                case 4:
                    ...
                    .Include(x => x.Cat)
                    .AsNoTracking()
                    .Where(x => x.Discount >= 1000000 && x.Discount <= 5000000)
                    .OrderByDescending(x => x.ProductName)
                    .ToList();
                    break;
                case 5:
